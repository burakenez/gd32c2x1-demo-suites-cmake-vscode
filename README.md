[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32c2x1-demo-suites-cmake-vscode)](https://github.com/burakenez/gd32c2x1-demo-suites-cmake-vscode/tags/)

# GD32C2x1 Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32C2x1 Demo Suites CMake Visual Studio Code** repository! This project is designed to integrate the CMake build system with Visual Studio Code, providing a streamlined development environment for **_GD32C2x1 Demo Suites V1.0.0_**.
...
- **🧩 Lightweight Templates:** A structured and organized template for GD32C2x1 microcontroller projects.
...
- **Notes:**
  ...
  - Update paths in these files if necessary:
    - `Projects/<BoardName>/<ProjectName>/.vscode/launch.json` (lines 14, 17):
      ...
      ```
      ```json
      "${workspaceFolder}/../../../Tools/xpack-openocd-0.11.0-3/scripts/target/openocd_gdlink_gd32c2x1.cfg"
      ```
...
### 2. **CMSIS/GD/GD32C2x1**
- **Version:** `V1.0.0 (2025-05-30)`
- **Path:** `Drivers/CMSIS/GD/GD32C2x1`
- Extracted from `GD32C2x1 Demo Suites V1.0.0`

### 3. **GD32C2x1_standard_peripheral**
- **Version:** `V1.0.0 (2025-05-30)`
- **Path:** `Drivers/GD32C2x1_standard_peripheral`
...
git clone --recursive https://github.com/burakenez/gd32c2x1-demo-suites-cmake-vscode.git
```
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32c2x1_it.h  # Interrupt handler declarations specific to GD32C2x1.
│           │   │   │   ├── gd32c2x1_libopt.h  # Library options and configurations for efficient use.
│           │   │   │   └── systick.h  # Definitions and declarations related to the SysTick timer.
│           │   │   ├── Src
│           │   │   │   ├── gd32c2x1_it.c  # Interrupt service routine implementations.
│           │   │   │   ├── main.c  # Entry point of the application, containing the main logic and system initialization.
│           │   │   │   ├── system_gd32c2x1.c  # System initialization, clock setup, and core configurations.
│           │   │   │   └── systick.c  # SysTick timer setup and related functionalities.
│           │   ├── Startup
│           │   │   └── startup_gd32c2x1.s  # Assembly code for initialization and vector table setup.
│           │   ├── User
...
│           ├── Drivers
│           │   ├── BSP/GD32C231C_EVAL  # Board support package configurations and drivers for GD32C231C_EVAL.
│           │   ├── CMSIS  # CMSIS drivers for Cortex-M processors, supporting GD32C2x1.
│           │   └── GD32C2x1_standard_peripheral  # Peripheral library for GD32C2x1.
...
│           ├── gd32c2x1_flash.ld  # Linker script for defining memory regions and placements.
│           └── GD32C2x1.svd  # System View Description file for debugging and register definitions. 
